...
- **Buttons**: Rounded pills for primary, rounded-md for secondary
- **Shadows**: `shadow-lg` for cards, `shadow-md` for interactive elements
- **Borders**: Subtle `border-gray-200` for card separation
